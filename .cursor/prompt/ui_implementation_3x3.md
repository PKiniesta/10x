...
<implementation_plan>
implementujesz brakujacy widok z doc/ui_plan.md 2.6 Nowa fiszka (manual)

Teraz przejrzyj zasady implementacji:

<implementation_rules>
Przestrzegaj regul z .cursor/rules @shared.mdc, @frontend.mdc, @astro.mdc, @react.mdc, @ui-shadcn-helper.mdc
</implementation_rules>

Przejrzyj zdefiniowane typy:

<types>
typy znajdziesz w types.ts
</types>
